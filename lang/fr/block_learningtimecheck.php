...
$string['configpagesize_desc'] = 'Le nombre max d\'étudiants affichés par page dans le corps du bloc';
...
$string['notseenfor'] = 'Nous n\'avons pas vu cet étudiant depuis au moins {$a} semaine(s)';
$string['nousers'] = 'Pas d\'utilisateur';
$string['onemonthnosee'] = 'Un mois';
$string['oneweeknosee'] = 'Une semaine';
