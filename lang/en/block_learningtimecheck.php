...
$string['configpagesize_desc'] = 'The max number of students displayed in the block body';
...
$string['notseenfor'] = 'We have not seen this user for {$a} weeks';
$string['nousers'] = 'No users';
$string['onemonthnosee'] = 'One month';
$string['oneweeknosee'] = 'One week';
