...
/**
 * Specialised restore task for the learningtimecheck block
 * (has own DB structures to backup)
 *
 * TODO: Finish phpdocs
 */
class restore_learningtimecheck_block_task extends restore_block_task {
    ...
    public function after_restore() {
        ...
        if (!empty($config->learningtimecheckid)) {
